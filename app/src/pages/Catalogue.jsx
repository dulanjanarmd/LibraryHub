...
const MANIFESTO_TEXT =
  "The SLIIT Library exists to democratize access to knowledge empowering every student researcher and faculty member to discover learn and create without boundaries. Our collection represents centuries of human thought from ancient philosophy to cutting edge artificial intelligence ensuring that the next generation of Sri Lankan innovators have the resources they need to shape the future.";
    ...
    >
      ...
      <div ref={headerRef} style={{ position: "relative", padding: "32px 48px 0" }}>
        ...
        >
          ...
          {(["newest", "title", "availability"]).map((s) => (
            <button
              key={s}
              onClick={() => setSortBy(s)}
              style={{
